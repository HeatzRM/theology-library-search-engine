class SearchHandler(object):
    def search_books(self, query, list_books):
        ...
        books_with_keyword = set.union(books_with_keyword, 
                    self.search_by_attribute(query, "Title", list_books))
        books_with_keyword = set.union(books_with_keyword, 
                    self.search_by_attribute(query, "Subtitle", list_books))
        books_with_keyword = set.union(books_with_keyword, 
                    self.search_by_attribute(query, "Author", list_books))
        books_with_keyword = set.union(books_with_keyword, 
